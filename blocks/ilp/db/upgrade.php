...
function xmldb_block_ilp_upgrade($oldversion=0) {
	...
	if ($result && $oldversion < 2008053101) {

    /// Define table ilp_post_category to be created
        $table = new XMLDBTable('ilp_post_category');
    ...
    /// Adding fields to table ilp_post_category
        ...
        $table->addFieldInfo('summary', XMLDB_TYPE_TEXT, 'small', null, XMLDB_NOTNULL, null, null, null, null);
