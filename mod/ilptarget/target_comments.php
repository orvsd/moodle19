...
require_capability('mod/ilptarget:view', $context);
	...
	if($action == 'updatecomment'){
		...
		if ($comments !== false) {
			...
			echo '<div class="forumpost ilpcomment boxaligncenter">'.format_text($comment->commentpost, $comment->format).'<div class="commands">'.fullname($commentuser).', '.userdate($comment->created, get_string('strftimedate')).'<br />'.ilptarget_update_comment_menu($comment->id,$context).'</div></div>';
